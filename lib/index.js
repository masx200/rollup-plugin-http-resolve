...
function isHttpProtocol(id) {
    return (
        (id === null || id === void 0 ? void 0 : id.startsWith("http://")) ||
        (id === null || id === void 0 ? void 0 : id.startsWith("https://"))
    );
}
const DEBUG = false;
    ...
    return {
        ...
        async resolveId(id, importer) {
            ...
            if (importer && isHttpProtocol(importer)) {
                ...
                if (id.startsWith("/")) {
                    ...
                    const resolvedPathname = path_1.default.join(
                        path_1.default.dirname(pathname),
                        id
                    );
        ...
        async load(id) {
            ...
            if (isHttpProtocol(id)) {
                ...
                if (cached) {
                    onUseCache === null || onUseCache === void 0
                        ? void 0
                        : onUseCache(id);
                    return cached;
                }
                onRequest === null || onRequest === void 0
                    ? void 0
                    : onRequest(id);
                if (fetcher) {
