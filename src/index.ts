        ...
        async load(id: string) {
            ...
            if (isHttpProtocol(id)) {
                ...
                if (fetcher) {
                    ...
                    const res = await fetch(id,{headers:{"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36 Edg/108.0.1462.54"}});
                    if (!res.ok) {
